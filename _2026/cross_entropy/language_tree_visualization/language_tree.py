    ...
    def construct(self):
        ...
        self.play(
            ...
            AnimationGroup(*[
                AnimationGroup(
                    ...
                    FadeIn(label, shift=DOWN * 0.1), lag_ratio=0.1)
        ...
        self.play(
            AnimationGroup(
                ...
                FadeIn(tree.node_group, run_time=1.5), lag_ratio=0.9)
        )
    ...
    def construct(self):
        ...
        self.play(
            AnimationGroup(
                ...
                FadeIn(tree.node_group, run_time=3), lag_ratio=0.9)
        )
