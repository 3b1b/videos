    ...
    def construct(self):
        ...
        self.play(
            AnimationGroup(
                ...
                GrowFromEdge(entropy_of_p_triangle, RIGHT)
            , lag_ratio = 0.5)
        , run_time = 2)
        ...
        self.play(
            ...
            AnimationGroup(
                AnimationGroup(
                    ...
                    TransformMatchingShapes(
                        entropy_formula,
                        kl_divergence_formula[R"\left(\sum_i p_i(-\log_2 p_i)\right)"]
                    , run_time = 2)
                ),
                Write(kl_divergence_formula["-"][1])
            , lag_ratio = 0.7)
        )
        ...
        for i in range(15):
            ...
            if i == 3:
                ...
                self.play(
                    ...
                    symbols_group.animate(run_time = 2).restore()
                , run_time = 2)
