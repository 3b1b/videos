...
class Robot(Group):
    ...
    def execute_instruction(self, instruction_index):
        ...
        return AnimationGroup(
            self.blink_antenna(),
            self.animate.shift(direction * self.move_amount * self.overhead_image_vertical.get_width()), lag_ratio=0.3)
...
class RobotOnMoon3(RobotOnMoon):
    ...
    def construct(self):
        ...
        def hide_tail_2(m): return m.set_opacity(0)
    ...
    def construct(self):
        ...
        self.play(
            AnimationGroup(
                ...
                AnimationGroup(
                    ...
                    FadeIn(new_encoding_text), lag_ratio=0.3), lag_ratio=0.4), run_time=6.5)
        self.wait(2)
        circ = Circle(
        ...
        self.play(
            AnimationGroup(
                ...
                perfect_example_group[:-1].animate(run_time=2).set_width(FRAME_WIDTH * 0.9).set_x(0).to_edge(DOWN, buff=0.4), lag_ratio=0.1)
        )
        ...
        self.play(
            FadeOut(code_words_text),
            FadeOut(Group(robot_2, mission_control_2), shift=DOWN),
            huffman_chart.animate(path_arc=PI * 0.1).scale(1.2).align_to(huffman_chart, RIGHT).center(), run_time=2)
        self.wait(3)
        ...
        self.play(
            AnimationGroup(
                ...
                Write(message_probability), run_time=4.5, lag_ratio=0.4)
        )
        self.wait(5)
        ...
        self.play(
            ...
            ReplacementTransform(log_of_both_sides["-n"], log_of_both_sides_simplified["-n"]), run_time=1)
        ...
        self.play(
            AnimationGroup(
                ...
                AnimationGroup(
                    ...
                    ShowCreation(curve, run_time=1), lag_ratio=0.5), lag_ratio=0.6), run_time=3)
        self.remove(message)
        ...
        self.play(
            ...
            FadeIn(VGroup(p_value_triangle, p_display)), run_time=0.9)
            ...
            if i == 1:
                anims.append(
                    AnimationGroup(
                        ...
                        information_definition.animate(run_time=2).set_opacity(1), lag_ratio=0.4)
                )
            if i == 12:
...
class PerfectEncodingsAndEntropyDefinitionV2(InteractiveScene):
    def construct(self):
        ...
        self.play(
            ...
            full_huffman_chart.bar_labels.animate.shift(0), run_time=1.3)
        ...
        for i in range(4):
            self.play(
                ...
                full_huffman_chart.reference_lines[reference_lines_order[i] + 1:].animate.set_opacity(0.1).set_color(WHITE), run_time=0.8)
        self.play(
        ...
        self.play(
            ...
            AnimationGroup(
                ...
                ], lag_ratio=0.3), lag_ratio=0.5, run_time=6)
        )
                ...
                self.play(
                    AnimationGroup(
                        AnimationGroup(
                            ...
                            Write(weighted_sum_formula_area[-len("=Area()"):], run_time=2), lag_ratio=0.6),
                ...
                anims.append(
                    AnimationGroup(
                        AnimationGroup(
                            ...
                            ReplacementTransform(weighted_sum_formula_area["Avg. information"], weighted_sum_formula_h["H(P)"]), run_time=2),
                        FadeIn(entropy_text, run_time=2), lag_ratio=0.4)
                )
            if i == 19:
                entropy_display = Tex(
...
class CrossEntropyDefinitionV2(InteractiveScene):
    def construct(self):
        ...
        # Center everything
        self.play(
            VGroup(first_distribution_chart, second_distribution_chart).animate.scale(1.3).arrange(buff=2).shift(DOWN * 0.5), run_time=2.5)
        ...
        self.play(
            ...
            ReplacementTransform(second_distribution_chart, p_chart, suspend_mobject_updating=True), run_time=2)
        self.wait(2)
        self.play(ReplacementTransform(first_distribution_chart, q_chart, suspend_mobject_updating=True), run_time=2)
        self.wait(3)
        ...
        self.play(
            ReplacementTransform(
                ...
                VGroup(q_chart_general.bars, q_chart_general.segments, q_chart_general.probability_labels), suspend_mobject_updating=True),
            ReplacementTransform(
                VGroup(p_chart.bars, p_chart.segments, p_chart.probability_labels),
                VGroup(p_chart_general.bars, p_chart_general.segments, p_chart_general.probability_labels), suspend_mobject_updating=True),
            FadeOut(VGroup(q_chart.bar_labels, p_chart.bar_labels)), run_time=2)
        self.wait(2)
        ...
        self.play(
            ...
            AnimationGroup(
                TransformFromCopy(
                    ...
                    VGroup(p_entropy_chart.segments.copy(), p_entropy_chart.probability_labels.copy()).set_opacity(1), run_time=2),
                p_entropy_chart.create(),
                Write(VGroup(p_entropy_text, p_entropy_formula)), lag_ratio=0.7)
        )
        self.clear()
        ...
        for i in range(4):
            ...
            anims = [
                AnimationGroup(
                    ...
                    qp_cross_entropy_chart.set_distribution(new_distribution), run_time=2)
            ]
            if i == 0:
        ...
        self.play(
            AnimationGroup(
                TransformFromCopy(
                    ...
                    VGroup(pq_cross_entropy_chart.segments.copy(), pq_cross_entropy_chart.probability_labels.copy()).set_opacity(1), run_time=2),
                AnimationGroup(*[
                ...
                Write(VGroup(pq_cross_entropy_text, pq_cross_entropy_formula)), lag_ratio=0.7)
        )
        self.wait(2)
        self.clear()
        q_entropy_chart.resume_updating()
            ...
            AnimationGroup(
                AnimationGroup(
                    ...
                    AnimationGroup(
                        ...
                        FadeIn(axes, shift=DOWN * 5 + LEFT, run_time=1.5), lag_ratio=0.2)
                ), lag_ratio=0.8)
        )
        ...
        self.play(
            AnimationGroup(
                ...
                FadeIn(f_of_q_dot, suspend_mobject_updating=True), lag_ratio=0.8)
        )
            ...
            if i == 1:
                ...
                anims.append(
                    AnimationGroup(
                        ...
                        Write(min_text, run_time=1.5), lag_ratio=0.2)
                )
            if i == 3:
...
class CrossEntropyDefinitionV3(InteractiveScene):
    def construct(self):
        ...
        self.play(
            ...
            AnimationGroup(*[label.animate.scale(0.01).shift(DOWN * 0.2).set_opacity(0) for label in p_chart.event_labels]), run_time=1)
        ...
        self.play(
            AnimationGroup(
                AnimationGroup(
                    ...
                    TransformMatchingShapes(information_2[-1].copy(), q_entropy_formula_extension["1"][1], path_arc=PI * 0.1, run_time=1.3), lag_ratio=0.3),
                Write(q_entropy_formula_extension[-2:]), lag_ratio=0.85)
        )
        ...
        self.play(
            AnimationGroup(
                AnimationGroup(
                    ...
                    TransformMatchingShapes(info_copy_2.copy(), qp_cross_entropy_formula_extension["1"][2], path_arc=PI * 0.1, run_time=1.3), lag_ratio=0.2),
                Write(qp_cross_entropy_formula_extension[-2:]), lag_ratio=0.85)
        )
        self.wait(1)
        self.play(
            FadeOut(
        ...
        self.play(
            ...
            AnimationGroup(*[h.animate.set_value(-math.log2(q)) for h, q in zip(qp_cross_entropy_chart_two_events.bar_heights, [0.9, 0.1])]), run_time=2)
        self.wait(2)
        self.play(FancyCircumscribe(q_entropy_chart_two_events.probability_labels, run_time=5))
        self.wait(1)
        self.play(FancyCircumscribe(qp_cross_entropy_chart_two_events.probability_labels, run_time=5))
        ...
        self.play(
            AnimationGroup(
                ...
                Write(q_entropy_formula_extension[-5:]), lag_ratio=0.85)
        )
        ...
        self.play(
            AnimationGroup(
                ...
                Write(qp_cross_entropy_formula_extension[-5:]), lag_ratio=0.85)
        )
        self.wait(1)
        self.play(
            FadeOut(
        ...
        distribution_2 = [t.get_value() for t in qp_cross_entropy_chart_two_events.distribution_trackers]
        q_entropy_chart_two_events_general = EntropyChart(
            distribution_1,
            event_labels=None,
            probability_labels=VGroup(*[
            ...
            AnimationGroup(
                ...
                FadeOut(
                    VGroup(
                        q_entropy_chart_two_events,
                        qp_cross_entropy_chart_two_events
                    ), suspend_mobject_updating=True), lag_ratio=0.2)
        )
        q_entropy_chart = q_entropy_chart_two_events_general
        qp_cross_entropy_chart = qp_cross_entropy_chart_two_events_general
        ...
        for i in range(num_changes):
            ...
            anims = [
                AnimationGroup(
                    q_entropy_chart.set_distribution(new_distribution_1),
                    qp_cross_entropy_chart.set_distribution(new_distribution_2), run_time=2)
            ]
            ...
            AnimationGroup(
                AnimationGroup(
                    FadeOut(
                        ...
                        shift=UL * 2, run_time=1, suspend_mobject_updating=True),
        ...
        self.play(
            ...
            q_entropy_chart.set_distribution([1 - epsilon_2, epsilon_2]), run_time=4)
        self.play(
            qp_cross_entropy_chart.set_distribution([epsilon_2, 1 - epsilon_2]),
            q_entropy_chart.set_distribution([epsilon_2, 1 - epsilon_2]), run_time=4)
        graph.suspend_updating()
...
class InformationEntropyAndCrossEntropy(InteractiveScene):
    def construct(self):
        ...
        self.play(
            ...
            FadeIn(definitions[2], shift=UP * 0.6), run_time=2)
        ...
        self.play(
            AnimationGroup(
                AnimationGroup(
                    ...
                    FadeIn(small_prob_log, shift=UP), run_time=2),
                FadeIn(arrow, run_time=1.5), lag_ratio=0.7)
        )
...
class DistanceBetweenDistributions(InteractiveScene):
    def construct(self):
        ...
        distribution1 = random_distribution(7)
        distribution2 = random_distribution(7)
        ...
        probability_labels_1 = VGroup(*[
            Tex(
                ...
                font_size=35
            ).set_color(interpolate_color(LIGHT_PINK, PURE_MAGENTA, i // (len(Q.bars) - 1))).set_stroke(width=15, color=BLACK, behind=True)
        ...
        probability_labels_2 = VGroup(*[
            Tex(
                ...
                font_size=35
            ).set_color(interpolate_color(GREEN_B, GREEN_D, i // (len(Q.bars) - 1))).set_stroke(width=15, color=BLACK, behind=True)
        ...
        Q_symbol = Tex("Q", font_size=60).set_color(PINK).set_stroke(width=15, color=BLACK, behind=True)
        ...
        connecting_line = always_redraw(
            ...
            Line(
                Q_symbol,
                P_symbol,
                stroke_width=clip(1 / (3 * get_kl_divergence(Q, P)), 0.2, 9),
                stroke_color=BLUE_B,
                stroke_opacity=0.5
            )
        )
        ...
        # Add Dashed lines
        dashed_lines = VGroup(*[
            DashedLine(Q.bars.get_bottom(), P.bars.get_top(), stroke_width=3)
            for _ in range(len(P.bars) + 1)
        ]).set_color(GREY).set_opacity(0.5).align_to(Q.bars, DOWN)
    ...
    def construct(self):
        ...
        self.play(
            AnimationGroup(
                ...
                randy.change("confused"), lag_ratio=0.2)
        )
        self.wait(1)
